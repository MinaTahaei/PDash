...
private:
  ...
  cInt PopScanbeam();
  bool InsertLocalMinimaIntoAEL(const cInt botY);
  ...
  bool ProcessHorizontals(bool IsTopOfScanbeam);
  bool ProcessHorizontal(TEdge *horzEdge, bool isTopOfScanbeam);
  void AddLocalMaxPoly(TEdge *e1, TEdge *e2, const IntPoint &pt);
  OutPt* AddLocalMinPoly(TEdge *e1, TEdge *e2, const IntPoint &pt);
  OutRec* GetOutRec(int idx);
  void AppendPolygon(TEdge *e1, TEdge *e2);
  bool IntersectEdges(TEdge *e1, TEdge *e2,
  ...
  bool BuildIntersectList(const cInt botY, const cInt topY);
