#ifndef __FXVERTSHADER_ES2_GLSL_H__
#define __FXVERTSHADER_ES2_GLSL_H__

const char *g_fxVertShader_es2_glsl =
"\n\
#ifdef GL_ES\n\
...
#endif /* __FXVERTSHADER_ES2_GLSL_H__ */
